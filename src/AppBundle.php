...
use eLife\Journal\DependencyInjection\SpamBundleTranslatorPass;
...
final class AppBundle extends Bundle
{
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new RemoveOptionalServicesPass());
        $container->addCompilerPass(new SpamBundleTranslatorPass());
