...
final class SubjectRewritingHttpClient implements HttpClient
{
    ...
    public function __construct(HttpClient $httpClient, array $replacements = [])
    {
    ...
    public function send(RequestInterface $request) : PromiseInterface
    {
        ...
        return $this->httpClient->send($this->rewriteRequest($request))->then(function (HttpResult $result) {
            return $this->rewriteResult($result);
        });
    }
    ...
    private function rewriteResult(HttpResult $result)
    {
