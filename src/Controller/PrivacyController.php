        ...
        $arguments['body'] = [
            ...
            ArticleSection::collapsible('users', 'General website users', 2, $this->render(
                ...
                ArticleSection::basic('How long do we retain the data for?', 3, $this->render(
                    ...
                    new Paragraph('Aggregated analytics data is retained for as long as it is relevant to business analysis and site development.'),
            ...
            ArticleSection::collapsible('editors-reviewers', 'Editors and reviewers', 2, $this->render(
