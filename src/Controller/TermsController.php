...
final class TermsController extends Controller
{
    public function termsAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ArticleSection::basic('Terms and Conditions of Use', 2,
                $this->render(ArticleSection::basic('Welcome and Consent to Terms', 3,
                    $this->render(
                ...
                $this->render(ArticleSection::basic('Ownership', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('License to Use Journal Articles and Related Content', 3,
                    $this->render(
                ...
                $this->render(ArticleSection::basic('Impermissible Uses', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Suspension of Use / Violation of these Terms and Conditions', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Disclaimer of Warranty', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Limitation of Liability', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Indemnity', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Interactive Features', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Infringement', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Modifications to eLife Site and Terms and Conditions', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Additional Terms for Certain Features', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('General', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Questions and Comments', 3,
                        $this->render(
            ...
            ArticleSection::basic('Privacy Policy', 2,
                $this->render(
                ...
                $this->render(ArticleSection::basic('Website visitors', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Gathering of personally identifying information', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Aggregated statistics', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Protection of certain personally identifying information', 3,
                        $this->render(
                ...
                $this->render(ArticleSection::basic('Business transfers', 3,
                        $this->render(
