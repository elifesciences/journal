...
final class ArticleTypesController extends Controller
{
    ...
    private function createFirstPage(array $arguments, string $type) : Response
    {
        static $impactStatements = [
            ...
            'scientific-correspondence' => 'Scientific Correspondence allows authors to challenge to the central findings of a published paper, and gives the original authors an opportunity to respond.',
