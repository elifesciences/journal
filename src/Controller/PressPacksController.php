...
final class PressPacksController extends Controller
{
    ...
    private function createFirstPage(array $arguments) : Response
    {
        ...
        $arguments['sidebar'] = [
            ...
            new Paragraph('The eLife media policy, encouraging authors to present and discuss their works ahead of publication and indicating that eLife does not release content under embargo, except in exceptional circumstances, can be found <a href="'.$this->generateDownloadLink('https://cdn.elifesciences.org/downloads/eLife-media-policy-For-the-Press.pdf').'">here</a>.'),
