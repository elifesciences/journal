...
final class PressPacksController extends Controller
{
    ...
    private function createFirstPage(array $arguments) : Response
    {
        ...
        $arguments['sidebar'] = [
            ...
            new Paragraph('The <a href="/media-policy">eLife media policy</a> encourages authors to present and discuss their works ahead of publication and indicates that eLife does not release content under embargo, except in exceptional circumstances.'),
