...
Learn more about <a href="'.$this->get('router')->generate('about-early-career').'">our work</a> and <a href="'.$this->get('router')->generate('about-people', ['type' => 'early-career']).'">advisory group</a>, <a href="https://crm.elifesciences.org/crm/community-news">sign up for our monthly news</a>,
