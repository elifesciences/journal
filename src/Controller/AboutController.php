...
final class AboutController extends Controller
{
    ...
    public function earlyCareerAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ...
            new DefinitionList([
                'Early Career Advisory Group' => 'eLife has invited a group of talented graduate students, postdocs and junior group leaders from across the world to our <a href="'.$this->get('router')->generate('about/people/early-career').'">Early-Career Advisory Group</a>. The ECAG acts as a voice for early-career researchers (ECRs) within eLife, representing their needs and aspirations and helping to develop new initiatives and shape current practices to change academic publishing for the better.',
            ]),
