...
final class AboutController extends Controller
{
    ...
    public function peerReviewAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ...
            ArticleSection::basic('Related links', 2,
                $this->render(Listing::unordered([
                    '<a href="'.$this->get('router')->generate('inside-elife-article', ['id' => 'e9091cea']).'">New from eLife: Preprints and peer review</a>',
                    '<a href="'.$this->get('router')->generate('inside-elife-article', ['id' => 'e9091cea']).'">New from eLife: What we have learned about preprints</a>',
