    ...
    public function opennessAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ...
            new DefinitionList([
                ...
                'Supporting reproducibility' => 'eLife authors are encouraged to publish their work in full and are required to provide the key underlying data as part of their paper. We support projects such as Research Resource Identifiers (RRIDs) that promote unambiguous identification of reagents and materials. eLife is also the publishing partner for the <a href="'.$this->get('router')->generate('collections/9b1e83d1').'">Reproducibility Project in Cancer Biology</a>.',
                'Making our software open-source' => 'The tools we develop to support research communication, including <a href="'.$this->get('router')->generate('inside-elife/0414db99').'">eLife Lens</a> and <a href="'.$this->get('router')->generate('inside-elife/33e4127f').'">Continuum</a>, are made openly available so that others can use and build upon them without constraint.',
            ]),
            ArticleSection::basic('Related links', 2,
                $this->render(Listing::unordered([
    ...
    public function earlyCareerAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ...
            new DefinitionList([
                ...
                'Involvement in peer review' => 'eLife encourages reviewers to involve junior colleagues as co-reviewers; we involve outstanding early-stage researchers as reviewers <a href="'.$this->get('router')->generate('inside-elife/31a5173b').'">in their own right</a>; and we enable all reviewers to receive credit for their contributions through services such as Publons and ORCID',
                'Taking advice' => 'eLife has invited a group of talented graduate students, postdocs and junior group leaders from laboratories across the world to our Early-Career Advisory Group to help guide the direction of the journal and to help us reshape science publishing. <a href="'.$this->get('router')->generate('inside-elife/f8ea71d8').'">Learn more</a> and sign up to have your say',
            ]),
