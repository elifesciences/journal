...
final class AboutController extends Controller
{
    ...
    public function researchCultureAction(Request $request) : Response
    {
        ...
        $arguments['body'] = [
            ...
            new Paragraph('eLife invests in research culture in a variety of ways, many of which involve working closely with early-career researchers (ECRs). With the guidance of our <a href="https://elifesciences.org/about/people/early-career">Early-Career Advisory Group</a>, we have established standards for diversity and inclusion across eLife, created peer networks and the <a href="https://elifesciences.org/inside-elife/a946c355/elife-community-ambassadors-243-volunteers-join-the-programme-in-2019"></a> eLife Ambassadors program</a>, increased <a href="https://elifesciences.org/inside-elife/31a5173b/elife-promotes-early-career-involvement-in-peer-review">ECR involvement on our editorial board and reviewer pool</a>, <a href="https://elifesciences.org/inside-elife/aff37cb5/early-career-travel-grants-applications-are-open-for-2020">awarded grants to early-career authors</a>, and showcased early-career talents and perspectives through <a href="https://elifesciences.org/interviews">interviews</a>, <a href="'.$this->get('router')->generate('podcast').'">podcasts</a> and <a href="https://elifesciences.org/collections/842f35d5/ecrwednesday-webinars">webinars</a>.'),
            ArticleSection::basic('Related links', 2,
                $this->render(Listing::unordered([
