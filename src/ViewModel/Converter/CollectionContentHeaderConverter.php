...
final class CollectionContentHeaderConverter implements ViewModelConverter
{
    ...
    public function convert($object, string $viewModel = null, array $context = []) : ViewModel
    {
        ...
        return new ViewModel\ContentHeader(
            $object->getTitle(),
            $this->contentHeaderImageFactory->forImage($object->getBanner(), true), $object->getImpactStatement(), true, [], new ViewModel\Profile(new Link($curatorName), $curatorImage), null, null,
