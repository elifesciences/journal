...
final class ReportReferenceConverter implements ViewModelConverter
{
    ...
    public function convert($object, string $viewModel = null, array $context = []) : ViewModel
    {
        ...
        if ($object->getDoi()) {
            return ViewModel\Reference::withDoi($object->getTitle(), new ViewModel\Doi($object->getDoi()), $object->getId(), $origin, $authors, $abstracts);
        }

        return ViewModel\Reference::withOutDoi(new ViewModel\Link($object->getTitle(), $object->getUri()), $object->getId(), $origin, $authors, $abstracts);
    }
