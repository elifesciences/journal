...
final class BookChapterReferenceConverter implements ViewModelConverter
{
    ...
    public function convert($object, string $viewModel = null, array $context = []) : ViewModel
    {
        ...
        if ($object->getDoi()) {
            return ViewModel\Reference::withDoi($object->getChapterTitle(), new ViewModel\Doi($object->getDoi()), $object->getId(), $this->label(), $origin, $authors, $abstracts);
        }

        return ViewModel\Reference::withOutDoi(new ViewModel\Link($object->getChapterTitle()), $object->getId(), $this->label(), $origin, $authors, $abstracts);
    }
