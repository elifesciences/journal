...
final class UnknownReferenceConverter implements ViewModelConverter
{
    ...
    public function convert($object, string $viewModel = null, array $context = []) : ViewModel
    {
        ...
        return ViewModel\Reference::withOutDoi(new ViewModel\Link($object->getTitle(), $object->getUri()), $object->getId(), $object->getDetails() ? [$object->getDetails()] : [], $authors, $abstracts);
    }
