...
final class PaginatorListingAnnotationTeasersConverter implements ViewModelConverter
{
    /**
    ...
    public function convert($object, string $viewModel = null, array $context = []) : ViewModel
    {
        ...
        if (0 === count($object->getItems())) {
            ...
            return ViewModel\ListingAnnotationTeasers::withPagination(
                $object->getItems(),
        ...
        return ViewModel\ListingAnnotationTeasers::basic($object->getItems(), $heading, 'listing');
    }

    public function supports($object, string $viewModel = null, array $context = []) : bool
    {
        return $object instanceof Paginator && ViewModel\ListingAnnotationTeasers::class === $viewModel;
    }
}
