...
final class CoverReviewedPreprintHighlightItemConverter implements ViewModelConverter
{
    use CreatesDate;
    ...
    {
        return $object instanceof Cover && ViewModel\HighlightItem::class === $viewModel && $object->getItem() instanceof ReviewedPreprint;
    }
}
