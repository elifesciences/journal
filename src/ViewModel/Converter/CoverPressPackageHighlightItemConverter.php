...
final class CoverPressPackageHighlightItemConverter implements ViewModelConverter
{
    use CreatesDate;
    ...
    {
        return $object instanceof Cover && ViewModel\HighlightItem::class === $viewModel && $object->getItem() instanceof PressPackage;
    }
}
