...
trait CreatesTeaserImage
{
    ...
    private function prominentTeaserImage(HasThumbnail $object) : ViewModel\TeaserImage
    {
    ...
    private function bigTeaserImage(HasThumbnail $object) : ViewModel\TeaserImage
    {
    ...
    private function smallTeaserImage(HasThumbnail $object) : ViewModel\TeaserImage
    {
