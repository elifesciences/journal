...
final class LabsControllerTest extends PageTestCase
{
    ...
    public function it_has_metadata()
    {
        ...
        $this->assertSame('Open source technology innovation news from eLife Sciences', $crawler->filter('link[rel="alternate"]')->attr('title'));
        $this->assertSame('/rss/labs.xml', $crawler->filter('link[rel="alternate"]')->attr('href'));
