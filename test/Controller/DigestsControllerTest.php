...
final class DigestsControllerTest extends PageTestCase
{
    ...
    public function it_has_metadata()
    {
        ...
        $this->assertSame('Cutting the jargon and putting the research in context, digests showcase some of the latest articles published in the journal.', $crawler->filter('meta[property="og:description"]')->attr('content'));
        $this->assertSame('Cutting the jargon and putting the research in context, digests showcase some of the latest articles published in the journal.', $crawler->filter('meta[name="description"]')->attr('content'));
