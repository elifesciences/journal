...
final class ArticleControllerTest extends PageTestCase
{
    ...
    public function it_displays_metrics()
    {
        ...
        $this->assertContains('5,678', $metrics->filter('.statistic-collection__item:contains("Page views") .statistic__counter')->text());
        $this->assertContains('9,012', $metrics->filter('.statistic-collection__item:contains("Downloads") .statistic__counter')->text());
        $this->assertContains('Views and downloads are accumulated for all versions if this paper published by eLife.', $metrics->text());
        $this->assertContains('1,234', $metrics->filter('.statistic-collection__item:contains("Citations") .statistic__counter')->text());
        $this->assertContains('The citation count is generated by polling the highest count across the following sources: Service One, Service Two', $metrics->text());
    }
    ...
    public function it_displays_content()
    {
                    ...
                    'funding' => [
                        'awards' => [
                            [
                                ...
                                'awardId' => 'Award ID',
                                'awardDoi' => '10.7554/eLife.09560.005',
                                'recipients' => [
                                    [
                                        'type' => 'person',
                                        'name' => [
        ...
        $this->assertSame('Download .RIS', $this->crawlerText($citeThisArticleLinks->eq(1)));
         ...
         $this->assertSame('Categories and tags', $crawler->filter('.main-content-grid > section.article-meta .article-meta__group_title')->text());
