...
final class PodcastControllerTest extends PageTestCase
{
    ...
    public function it_has_metadata()
    {
        ...
        $this->assertSame('Podcast | eLife', $crawler->filter('title')->text());
        $this->assertSame('/podcast', $crawler->filter('link[rel="canonical"]')->attr('href'));
        $this->assertSame('http://localhost/podcast', $crawler->filter('meta[property="og:url"]')->attr('content'));
        $this->assertSame('Podcast', $crawler->filter('meta[property="og:title"]')->attr('content'));
