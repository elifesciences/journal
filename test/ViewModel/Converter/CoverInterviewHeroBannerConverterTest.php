...
use eLife\Journal\ViewModel\Converter\CoverInterviewHeroBannerConverter;
...
final class CoverInterviewHeroBannerConverterTest extends ModelConverterTestCase
{
    ...
    public function setUpConverter()
    {
        ...
        $this->converter = new CoverInterviewHeroBannerConverter(
            $urlGenerator
        );
    }
